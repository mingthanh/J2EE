...
const I18N_MESSAGES = {
  vi: {
    ...
    reports_title: 'Báo cáo - Jolliebee',
    reports_badge: 'Báo cáo trực quan',
    reports_hero_title: 'Jolliebee',
    reports_hero_copy: 'Trang này tổng hợp khối lượng công việc, mức ưu tiên, trạng thái và tiến độ dự án để bạn nhận ra điểm nghẽn nhanh hơn.',
    reports_refresh: 'Làm mới báo cáo',
    reports_summary_title: 'Tóm tắt điều hành',
    reports_summary_copy: 'Các chỉ số chính để theo dõi tốc độ xử lý và áp lực công việc hiện tại.',
    reports_status_title: 'Phân bổ theo trạng thái',
    reports_status_copy: 'Xem ngay số lượng issue ở từng giai đoạn để biết luồng công việc đang tắc ở đâu.',
    reports_priority_title: 'Ưu tiên công việc',
    reports_priority_copy: 'Biểu đồ thanh cho biết nhóm đang dồn lực vào các việc quan trọng đến mức nào.',
    reports_workload_title: 'Khối lượng theo dự án',
    reports_workload_copy: 'So sánh tổng issue, đang làm và hoàn thành của từng dự án trong cùng một nơi.',
    reports_health_title: 'Tình trạng vận hành',
    reports_health_copy: 'Một vài tỷ lệ quan trọng giúp đọc sức khỏe backlog nhanh hơn.',
    reports_no_data: 'Chưa có đủ dữ liệu để tạo báo cáo',
    reports_no_data_copy: 'Hãy thêm dự án hoặc issue rồi quay lại để xem biểu đồ trực quan.',
    reports_table_project: 'Dự án',
    reports_table_total: 'Tổng issue',
    reports_table_in_progress: 'Đang làm',
    reports_table_done: 'Hoàn thành',
    reports_table_completion: 'Tỷ lệ hoàn thành',
    reports_metric_completion_rate: 'Tỷ lệ hoàn thành',
    reports_metric_active_projects: 'Dự án hoạt động',
    reports_metric_unassigned: 'Issue chưa giao',
    reports_metric_overdue: 'Issue quá hạn',
  ...
  en: {
    ...
    reports_title: 'Reports - Jolliebee',
    reports_badge: 'Visual reports',
    reports_hero_title: 'Jolliebee',
    reports_hero_copy: 'This page summarizes workload, priority, status, and project progress so you can spot bottlenecks faster.',
    reports_refresh: 'Refresh report',
    reports_summary_title: 'Executive summary',
    reports_summary_copy: 'Key indicators to track delivery speed and current workload pressure.',
    reports_status_title: 'Status distribution',
    reports_status_copy: 'See how many issues sit in each stage so bottlenecks are obvious.',
    reports_priority_title: 'Priority mix',
    reports_priority_copy: 'A bar chart showing how much of the team workload is concentrated in important items.',
    reports_workload_title: 'Workload by project',
    reports_workload_copy: 'Compare total, in-progress, and completed issues for each project in one place.',
    reports_health_title: 'Delivery health',
    reports_health_copy: 'A few critical ratios to read backlog health at a glance.',
    reports_no_data: 'Not enough data to build the report yet',
    reports_no_data_copy: 'Add a project or some issues, then come back to see the visual report.',
    reports_table_project: 'Project',
    reports_table_total: 'Total issues',
    reports_table_in_progress: 'In progress',
    reports_table_done: 'Done',
    reports_table_completion: 'Completion rate',
    reports_metric_completion_rate: 'Completion rate',
    reports_metric_active_projects: 'Active projects',
    reports_metric_unassigned: 'Unassigned issues',
    reports_metric_overdue: 'Overdue issues',
